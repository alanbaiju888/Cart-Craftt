  ...
  return (
    <div className="signUpContainer">
        <div className='signUp'>
            <h2 className=' text-secondary create_acc'>Create Account</h2>
            <form onSubmit={register} autoComplete='off'>

        <div>
            <label className='textwhite  fs-5' htmlFor="inputName" id='sn'>
                Name
            </label>
                <input className='signdo' type="text"
...
<div>
            ...
            <label className='textwhite ' htmlFor="inputNum" id='sp'>
                Phone
            </label>
                <input className='signdo' type="tel"
        ...
        <div>
            <label className='textwhite ' htmlFor='inputEmail' id='se'>
                Email
            </label>
                <input className='signdo' type="email"
                value={email}
                id='inputEmail'
        ...
        <div  className='password-input-container' id='spa'>
            <label className='textwhite ' htmlFor='inputPass'>
                Password
            </label>
                <input className='signdo' type={passwordVisible ?  'text' : 'password'}
